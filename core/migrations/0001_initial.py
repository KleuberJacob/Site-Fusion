    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-cog', 'Engrenagem'), ('lni-stats-up', 'Gráfico'), ('lni-rocket', 'Foguete'), ('lni-mobile', 'Mobile'), ('lni-layers', 'Design'), ('lni-users', 'Usuários')], max_length=12, verbose_name='Ícone')),
            ],
            options={
